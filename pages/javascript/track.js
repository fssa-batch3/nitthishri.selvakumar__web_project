...
function booking_detail(item) {
  ...
  let both_box = document.createElement("div")
  both_box.setAttribute("id", "both_box")
  whole_full_box.append(both_box)

  let full_box = document.createElement("div")
  ...
  let repaired_img = document.createElement("img")
  ...
  let full_detail_box = document.createElement("div")
  ...
  let track_report = document.createElement("div")
...
track_report.append(link)
  ...
  if (last_email == item.email) {
    // console.log("kjdfk")
    para1.innerText = " The request for the restore your product is keep under process and you will check the result after 24 hours"
